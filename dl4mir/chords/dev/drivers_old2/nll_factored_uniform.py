...
def main(args):
    ...
    quality_classifier = optimus.Softmax(
    ...
    quality_nll = optimus.NegativeLogLikelihood(
        name="quality_nll")
    ...
    trainer_edges = optimus.ConnectionManager([
        ...
        (quality_idx, quality_nll.target_idx)])
    ...
    joint_prob = optimus.CrossProduct(
        name='joint_prob')
    ...
    predictor_edges = optimus.ConnectionManager([
        ...
        (layer3.output, root_classifier.input),
        (layer3.output, quality_classifier.input),
        (quality_classifier.output, joint_prob.input_a),
        (root_classifier.output, joint_prob.input_b),
        (joint_prob.output, posterior)])

    print "predictor"
    predictor = optimus.Graph(
        name=GRAPH_NAME,
        inputs=[input_data],
        nodes=all_nodes + [joint_prob],
