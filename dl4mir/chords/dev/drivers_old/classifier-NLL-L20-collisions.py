...
VOCAB = 157
LEARNING_RATE = 0.002
PFILE = "/media/attic/dl4mir/chord_estimation/partitions/classifier-NLL-L20-uniform/deleteme/0/train_collisions_0x75.json"
...
def main(args):
    ...
    stream = S.minibatch(
        D.create_uniform_quality_stream(
            stash, TIME_DIM, partition_labels=json.load(open(PFILE))),
        batch_size=50,
